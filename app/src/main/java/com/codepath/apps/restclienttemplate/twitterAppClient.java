 ...
 * 
 */
public class twitterAppClient extends OAuthBaseClient {
	...
	public twitterAppClient(Context context) {
	...
	public void getFeed(JsonHttpResponseHandler handler) {
	...
	public void sendTweet(JsonHttpResponseHandler handler, String tweet) {
	...
	public void getNextFeedPage(JsonHttpResponseHandler handler, long maxID) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams requestParams = new RequestParams();
		requestParams.put("count", 25);
